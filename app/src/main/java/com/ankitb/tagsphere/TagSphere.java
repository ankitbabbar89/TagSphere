 ...
 */
public class TagSphere extends ViewGroup{
    ...
    public TagSphere(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public TagSphere(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TagSphere(Context context) {
        super(context);
    }
